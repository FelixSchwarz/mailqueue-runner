...
The configuration file uses the traditional "ini"-like format:
    ...
    # optional: "starttls" (default, uses STARTTLS if the server supports it) or
    # "implicit" (TLS right after connecting, always used for "smtp_port = 465")
    # smtp_tls = starttls
...
At the moment I test Python 3.8-3.13 as well as pypy3 on Linux.
...
The code is licensed unter the MIT license.
